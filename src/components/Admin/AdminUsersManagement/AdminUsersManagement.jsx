...
const AdminUsersManagement = () => {
  ...
  const fetchUsers = async () => {
    try {
      setLoading(true);
      const response = await fetch(`${API_URL}/admin/users?page=${currentPage}&limit=${ITEMS_PER_PAGE}`, {
        headers: {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {(isAddMode || isEditMode) && (
          <div className="bg-gray-800 rounded-xl shadow-lg mb-8 overflow-hidden border border-gray-700">
            ...
            <form onSubmit={isAddMode ? handleAddUser : handleUpdateUser} className="p-5">
            ...
            <div className="p-5">
              <div className="flex flex-col md:flex-row">
                ...
                <div className="md:w-1/4 flex flex-col items-center p-4">
                  ...
                  <h3 className="text-xl font-semibold text-white">{viewUserDetails.fullName}</h3>
                  ...
                  <span className="text-gray-400 text-sm mt-2">@{viewUserDetails.username}</span>
                ...
                <div className="md:w-3/4 p-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* Contact Information */}
                    <div className="space-y-4">
                      <h4 className="text-indigo-400 font-medium border-b border-gray-700 pb-2">Contact Information</h4>
                    ...
                    {/* Account Details */}
                    <div className="space-y-4">
                      <h4 className="text-indigo-400 font-medium border-b border-gray-700 pb-2">Account Information</h4>
                      
                      <div>
                        <p className="text-gray-400 text-sm">Account Created</p>
                        <div className="flex items-center mt-1">
                          <Clock size={16} className="text-gray-500 mr-2" />
                          <p className="text-white">{formatDate(viewUserDetails.createdAt)}</p>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="flex items-center mt-1">
                          <Clock size={16} className="text-gray-500 mr-2" />
                          <p className="text-white">{viewUserDetails.lastLogin ? formatDate(viewUserDetails.lastLogin) : 'Never'}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4 md:col-span-2">
                      <h4 className="text-indigo-400 font-medium border-b border-gray-700 pb-2">Financial Information</h4>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="bg-gray-700 rounded-lg p-4">
                          ...
                          <div className="flex items-center mt-1">
                            ...
                            <p className="text-white text-lg font-semibold">{viewUserDetails.Balance || 0}</p>
                          </div>
                        </div>
                        ...
                        <div className="bg-gray-700 rounded-lg p-4">
                          ...
                          <div className="flex items-center mt-1">
                            ...
                            <p className="text-white text-lg font-semibold">{viewUserDetails.totalDeposit || 0}</p>
                          </div>
                        </div>
                        ...
                        <div className="bg-gray-700 rounded-lg p-4">
                          ...
                          <div className="flex items-center mt-1">
                            <DollarSign size={16} className="text-orange-500 mr-2" />
                            <p className="text-white text-lg font-semibold">{viewUserDetails.totalWithdraw || 0}</p>
                          </div>
                        </div>
                        
                        <div className="bg-gray-700 rounded-lg p-4">
                          <p className="text-gray-400 text-sm">Lifetime Balance</p>
                          <div className="flex items-center mt-1">
                            <DollarSign size={16} className="text-purple-500 mr-2" />
                            <p className="text-white text-lg font-semibold">{viewUserDetails.totalBalance || 0}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="mt-6 flex justify-end space-x-3">
                    ...
                    <button
                      onClick={() => handleToggleUserStatus(viewUserDetails._id, viewUserDetails.isActive)}
        ...
        <div className="bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-700">
          {loading && users.length === 0 ? (
            ...
            <div className="p-8 text-center">
              ...
              <p className="text-gray-400 mb-4">You haven't added any users yet.</p>
              <button
            ...
            <div className="p-8 text-center">
              ...
              <p className="text-gray-400 mb-4">No users match your search criteria.</p>
              <button
                        ...
                        <div className="flex items-center">
                          <div className="h-10 w-10 flex-shrink-0 mr-3">
                            <div className="h-10 w-10 rounded-full bg-gray-700 flex items-center justify-center overflow-hidden border border-gray-600">
                              {user.profilePhoto ? (
                                <img src={user.profilePhoto} alt={user.fullName} className="h-10 w-10 object-cover" />
                              ) : (
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div className="flex justify-end space-x-2">
                          ...
                          <button
                            ...
                            className={user.isActive ? "text-orange-400 hover:text-orange-300 p-1" : "text-green-400 hover:text-green-300 p-1"}
