...
const AdminPaymentMethod = () => {
  ...
  const handleUpdatePaymentMethod = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/admin/payment-methods/${selectedMethod._id}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('adminToken')}`,
          'Content-Type': 'application/json'
  ...
  const handleToggleStatus = async (methodId, currentStatus) => {
    try {
      ...
      const response = await fetch(`${API_URL}/admin/payment-methods/${methodId}/status`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('adminToken')}`,
          'Content-Type': 'application/json'
      ...
      setSuccess(`Payment method ${!currentStatus ? 'activated' : 'deactivated'} successfully`);
      fetchPaymentMethods();
      setTimeout(() => setSuccess(null), 3000);
    } catch (err) {
      console.error('Error updating payment method status:', err);
      setError(err.message || 'Failed to update payment method status. Please try again.');
      setTimeout(() => setError(null), 3000);
    } finally {
      setLoading(false);
    }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {(isAddMode || isEditMode) && (
          <div className="bg-gray-800 rounded-xl shadow-lg mb-8 overflow-hidden border border-gray-700">
            ...
            <form onSubmit={isAddMode ? handleAddPaymentMethod : handleUpdatePaymentMethod} className="p-5">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g., bKash, Nagad, Rocket, Bank Transfer"
                    />
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs text-gray-400">
                      Provide instructions on how users should make payments using this method
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-700">
          {loading && paymentMethods.length === 0 ? (
            ...
            <div className="p-8 text-center">
              ...
              <h3 className="text-xl font-medium text-gray-300 mb-2">No Payment Methods Found</h3>
            ...
            <div className="p-8 text-center">
              ...
              <p className="text-gray-400 mb-4">No payment methods match your search criteria.</p>
              <button
                    ...
                    <tr key={method._id} className="hover:bg-gray-700/30">
                      ...
                      <td className="px-6 py-4">
                        <div className="text-sm text-gray-300 max-w-xs truncate">
                          {method.instructions || <span className="text-gray-500 italic">No instructions provided</span>}
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div className="flex justify-end space-x-2">
                          ...
                          <button
                            ...
                            className={method.isActive ? "text-orange-400 hover:text-orange-300 p-1" : "text-green-400 hover:text-green-300 p-1"}
        ...
        <div className="mt-8 bg-indigo-900/30 border border-indigo-500/40 rounded-lg p-4 text-indigo-100">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="font-medium text-indigo-300">Payment Methods Information</h3>
              <p className="text-sm mt-1">
                These payment methods will be displayed to users when they make deposit or withdrawal requests. 
                Only active payment methods will be visible to users. Make sure to provide clear instructions
                for each payment method to help users complete their transactions successfully.
              </p>
            </div>
          </div>
        </div>
