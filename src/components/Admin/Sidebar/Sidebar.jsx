...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { path: "AdminNewRegisterBonus", icon: UserCog, label: "Bonus Settings" },
    { path: "AdminReffarSetting", icon: UserCog, label: "Referral System Settings" },
    { path: "AdminSocialMedia ", icon: UserCog, label: "Social Media " },
